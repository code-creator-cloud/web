      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="border-0 shadow-md bg-lighter">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between bg-bin p-2 rounded-lg text-hover/80">
        ...
        <Card className="border-0 shadow-md bg-lighter">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between bg-bin p-2 rounded-lg text-gold/80">
        ...
        <Card className="border-0 shadow-md bg-lighter">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2 text-hover">
              ...
              >
                ...
                <SelectContent className='text-gray-400 bg-bin'>
            ...
            <div className="space-y-2 text-hover">
              ...
              <Input
                ...
                min="0"
                max="10"
                className='border-none bg-bin text-gray-400'
              />
            </div>
          </CardContent>
        </Card>
